...
app.use(function (req, res, next) {
  res.header(
    ...
    "default-src 'unsafe-inline';script-src 'unsafe-inline';object-src 'unsafe-inline';img-src 'self';media-src 'unsafe-inline';frame-src 'unsafe-inline';font-src 'unsafe-inline';connect-src 'unsafe-inline';style-src 'unsafe-inline'; style-src-elem 'self'"
  );
  next();
});
